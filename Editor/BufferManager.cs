...
namespace ItIsNotOnlyMe.MarchingCubes
{
    public class BufferManager
    {
        ...
        private Dictionary<int, TriangulosBufferManager> _datosDiccionario;
        ...
        public BufferManager(ComputeShader computeShader, float isoLevel)
        {
            ...
            _datosDiccionario = new Dictionary<int, TriangulosBufferManager>();
        ...
        {
            _datos.Add(datos);
            _datosDiccionario.Add(datos.Id, new TriangulosBufferManager());
        }
        ...
        public void ActualizarDatos(IObtenerDatos datos)
        {
            ...
            ComputeBuffer triangulosbuffer = _datosDiccionario[datos.Id].NuevoTriangulos(triangulosCount, triangulosStride);
        ...
        public IEnumerable<ComputeBuffer> Triangulos()
        {
            foreach (IObtenerDatos datos in _datos)
                yield return _datosDiccionario[datos.Id].Triangulos;
        }
        ...
        {
            foreach (KeyValuePair<int, TriangulosBufferManager> par in _datosDiccionario)
    ...
    public class BufferManager2
    {
        ...
        public BufferManager2(ComputeShader computeSahder, float isoLevel)
        {
            _datos = new List<IObtenerDatos>();
